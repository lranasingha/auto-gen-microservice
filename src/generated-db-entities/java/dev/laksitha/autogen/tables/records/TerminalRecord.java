...
public class TerminalRecord extends UpdatableRecordImpl<TerminalRecord> implements Record4<String, String, String, String> {
    ...
    @Override
    public TerminalRecord values(String value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TerminalRecord(String id, String name, String description, String status) {
        super(Terminal.TERMINAL);
